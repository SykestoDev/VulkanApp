...
void VulkanRenderer::CreateDescriptorSetLayout() {
	...
	// Combined image sampler descriptor - ** NEW TUT ** //
	VkDescriptorSetLayoutBinding samplerLayoutBinding{};
	samplerLayoutBinding.binding = 1; // Next binding after uniform buffer
	samplerLayoutBinding.descriptorCount = 1;
	samplerLayoutBinding.descriptorType = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
	samplerLayoutBinding.stageFlags = VK_SHADER_STAGE_FRAGMENT_BIT;
	samplerLayoutBinding.pImmutableSamplers = nullptr; // Optional

	// Combine the bindings into a single layout - ** NEW TUT ** //
...
void VulkanRenderer::CreateGraphicsPipeline() {
	auto vertShaderCode = readFile("../VulkanImageSamplerShaders/vert.spv");
	auto fragShaderCode = readFile("../VulkanImageSamplerShaders/frag.spv");
...
void VulkanRenderer::CreateDescriptorSets() {
	...
	for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
		...
		// Update the descriptor sets with buffer and image bindings
