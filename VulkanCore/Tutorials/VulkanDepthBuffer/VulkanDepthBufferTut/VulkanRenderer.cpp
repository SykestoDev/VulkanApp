...
void VulkanRenderer::InitVulkan() {
	...
	CreateCommandPool();
	CreateDepthResources();	// ** NEW TUT ** //
	CreateFramebuffers();	// ** NEW TUT ** // 
	CreateTextureImage();		
...
void VulkanRenderer::CreateImageViews() {
	...
	for (uint32_t i = 0; i < swapChainImages.size(); i++) {
		swapChainImageViews[i] = CreateImageView(swapChainImages[i],
			swapChainImageFormat, VK_IMAGE_ASPECT_COLOR_BIT);	// ** NEW TUT ** //
	}
}
// ** NEW TUT ** //
void VulkanRenderer::CreateRenderPass() {
	...
	subpass.pDepthStencilAttachment = &depthAttachmentRef;	 // ** NEW TUT ** //
	...
	dependency.dstStageMask = VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT |
		VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT;;		// ** NEW TUT ** //
	dependency.dstAccessMask = VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT |
		VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT;		// ** NEW TUT ** //
	...
	renderPassInfo.attachmentCount = static_cast<uint32_t>(attachments.size());	 // ** NEW TUT ** //
	renderPassInfo.pAttachments = attachments.data();							 // ** NEW TUT ** //
...
void VulkanRenderer::CreateFramebuffers() {
	...
	for (size_t i = 0; i < swapChainImageViews.size(); i++) {
		...
		framebufferInfo.attachmentCount = static_cast<uint32_t>(attachments.size());	// ** NEW TUT ** //
		framebufferInfo.pAttachments = attachments.data();								// ** NEW TUT ** //
...
void VulkanRenderer::CreateTextureImage() {
	...
	stbi_uc* pixels = stbi_load("../VulkanTextures/texture.jpeg", &texWidth,
...
void VulkanRenderer::RecordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
	...
	renderPassInfo.clearValueCount = static_cast<uint32_t>(clearValues.size()); // ** NEW TUT ** //
	renderPassInfo.pClearValues = clearValues.data();	// ** NEW TUT ** //
...
VkImageView VulkanRenderer::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
	...
	viewInfo.subresourceRange.aspectMask = aspectFlags;	 // ** NEW TUT ** //
