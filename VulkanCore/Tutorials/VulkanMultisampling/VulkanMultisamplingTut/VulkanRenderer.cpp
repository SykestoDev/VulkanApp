...
void VulkanRenderer::GetPhysicalDevice() {
	...
	for (const auto& device : devices) {
		...
		if (IsDeviceSuitable(device)) {
			...
			msaaSamples = GetMaxUsableSampleCount();	// ** NEW TUT ** //
			break;					
		}
	}
...
void VulkanRenderer::CreateRenderPass() {
	...
	colorAttachment.samples = msaaSamples;			// ** NEW TUT ** //
	colorAttachment.loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR;				
	colorAttachment.storeOp = VK_ATTACHMENT_STORE_OP_STORE;				
	colorAttachment.stencilLoadOp = VK_ATTACHMENT_LOAD_OP_DONT_CARE;	
	colorAttachment.stencilStoreOp = VK_ATTACHMENT_STORE_OP_DONT_CARE;  
	colorAttachment.initialLayout = VK_IMAGE_LAYOUT_UNDEFINED;		
	colorAttachment.finalLayout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;		// ** NEW TUT ** //
	...
	depthAttachment.samples = msaaSamples;			// ** NEW TUT ** //
	...
	subpass.pResolveAttachments = &colorAttachmentResolveRef;		// ** NEW TUT ** //
...
void VulkanRenderer::CreateGraphicsPipeline() {
	...
	multisampling.sampleShadingEnable = VK_TRUE;			// enable sample shading in the pipeline	** NEW TUT ** //
	multisampling.rasterizationSamples = msaaSamples;		// ** NEW TUT ** //
	//multisampling.minSampleShading = 1.0f;
	multisampling.minSampleShading = 0.2f; // min fraction for sample shading; closer to one is smoother  ** NEW TUT ** //
...
void VulkanRenderer::CreateImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkSampleCountFlagBits numSamples,
	...
	imageInfo.samples = numSamples;		// ** NEW TUT ** //
