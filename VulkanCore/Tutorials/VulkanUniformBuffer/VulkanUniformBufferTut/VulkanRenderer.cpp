...
void VulkanRenderer::InitVulkan() {
	...
	CreateImageViews();        
	CreateRenderPass();		
	CreateDescriptorSetLayout();  // ** NEW TUT ** //
	CreateGraphicsPipeline();  
	CreateFramebuffers();	   
	CreateCommandPool();
	CreateVertexBuffer();  
	CreateIndexBuffer();  
	CreateUniformBuffers();		  // ** NEW TUT ** //
...
void VulkanRenderer::CleanUp() {
	...
	for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
		...
		vkDestroyBuffer(device, uniformBuffers[i], nullptr);	 // ** NEW TUT ** //
		vkFreeMemory(device, uniformBuffersMemory[i], nullptr);  // ** NEW TUT ** //
	}
...
void VulkanRenderer::CreateGraphicsPipeline() {
	auto vertShaderCode = readFile("../VertexUniformBufferShaders/vert.spv");
	auto fragShaderCode = readFile("../VertexUniformBufferShaders/frag.spv");
	...
	pipelineLayoutInfo.setLayoutCount = 1;						// ** NEW TUT ** //
	pipelineLayoutInfo.pSetLayouts = &descriptorSetLayout;		// ** NEW TUT ** //
