...
bool VulkanRenderer::IsDeviceSuitable(VkPhysicalDevice device) {
	...
	return  indices.IsComplete() && isDiscreteGPU && hasGeometryShader &&
...
void VulkanRenderer::DrawFrame() {
	...
	// Check to see if SwapChain is out of date ** NEW TUT **
	...
	// Only reset the fence if we are submitting work ** NEW TUT **
	...
	VkPipelineStageFlags waitStages[] = { VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT };
	 ...
	 // Check to see if Swapchain is outdated ** NEW TUT **
...
void VulkanRenderer::RecreateSwapChain() {
	...
	vkDeviceWaitIdle(device);
	CleanupSwapChain();  // Delete old Swapchain
