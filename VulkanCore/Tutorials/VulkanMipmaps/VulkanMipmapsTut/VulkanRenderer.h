...
private:
	...
	void CreateImageViews();	   // ** NEW TUT ** //    
	void CreateRenderPass();
	void CreateDescriptorSetLayout();  
	void CreateGraphicsPipeline();  
	void CreateFramebuffers();		
	void CreateCommandPool();
	void CreateDepthResources();	// ** NEW TUT ** //
	void CreateTextureImage();		// ** NEW TUT ** //
	void CreateTextureImageView();	// ** NEW TUT ** //
	void CreateTextureSampler();	// ** NEW TUT ** //
