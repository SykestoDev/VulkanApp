...
void VulkanRenderer::InitVulkan() {
	...
	CreateDescriptorPool();		// ** NEW TUT ** //
	CreateDescriptorSets();		// ** NEW TUT ** //
...
void VulkanRenderer::CreateGraphicsPipeline() {
	auto vertShaderCode = readFile("../VertexDescriptorPoolNSetsShaders/vert.spv");
	auto fragShaderCode = readFile("../VertexDescriptorPoolNSetsShaders/frag.spv");
	...
	rasterizer.frontFace = VK_FRONT_FACE_COUNTER_CLOCKWISE;		// ** NEW TUT ** //
...
void VulkanRenderer::CreateDescriptorSets() {
	...
	for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
		...
		descriptorWrite.pImageInfo = nullptr;        // Not used here
		descriptorWrite.pTexelBufferView = nullptr; // Not used here
